...
router.post('/notifyVenmo', checkAuth, (req, res, next) => {
  ...
  if (access === 'customer') {
    knex('users')
      ...
      .then((users) => {
        ...
        console.log('Uncomment nodemailer in ROUTE notifyVenmo.js');
        ...
        //    subject: 'Laundry Service - New Venmo Order',
        //    html: `<div>
        //       <h1>Laundry Sucks.</h1>
        //       <h4>Venmo order has been submitted!  Verify if customer has sent payment via Venmo.</h4>
        //       <ul>
        //         <li>Order #: ${orderId}</li>
